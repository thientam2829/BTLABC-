...
namespace BTLAB1
{
    class Program
    {
        ...
        { 
            ...
            Console.WriteLine("===========================================================");
            Console.WriteLine("DANH SACH UNG VIEN DA NHAP ");
            Console.WriteLine("===========================================================");
            Console.WriteLine("+ HovaTen : {0} \n + NAMSINH: {1} \n + GIOITINH : {2} \n + CHIEUCAO: {3} \n + CANNANG: {4} \n + QUEQUAN: {5} \n + CHUYENNGANH: {6} \n + DIEMTRUNGBINH: {7} ", TEN1, NAMSINH1, GIOITINH1, CHIEUCAO1, CANNANG1, QUEQUAN1, CHUYENNGANH1, DIEMTRUNGBINH1);
            Console.WriteLine("+ HovaTen : {0} \n + NAMSINH: {1} \n + GIOITINH : {2} \n + CHIEUCAO: {3} \n + CANNANG: {4} \n + QUEQUAN: {5} \n + CHUYENNGANH: {6} \n + DIEMTRUNGBINH: {7} ", TEN2, NAMSINH2, GIOITINH2, CHIEUCAO2, CANNANG2, QUEQUAN2, CHUYENNGANH2, DIEMTRUNGBINH2);
            Console.WriteLine("+ HovaTen : {0} \n + NAMSINH: {1} \n + GIOITINH : {2} \n + CHIEUCAO: {3} \n + CANNANG: {4} \n + QUEQUAN: {5} \n + CHUYENNGANH: {6} \n + DIEMTRUNGBINH: {7} ", TEN3, NAMSINH3, GIOITINH3, CHIEUCAO3, CANNANG3, QUEQUAN3, CHUYENNGANH3, DIEMTRUNGBINH3);
            Console.ReadKey();
        }
